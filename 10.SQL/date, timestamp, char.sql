...
select to_timestamp('2022-01-01 14:36:52', 'yyy-mm-dd hh24:mi:ss'); 
...
--	, to_char(hiredate, 'yyyy month') as hiredate_str_04
	, to_char(hiredate, 'yyyy w d') as hiredate_str_05
...
temp_01 as
(
select a.*, to_char(hiredate, 'yyyy-mm-dd') as hire_date_str
	, hiredate::timestamp as hiretime
from hr.emp a
)
select empno, hiredate, hire_date_str, hiretime
--	, to_char(hiretime, 'yyyy/mm/dd hh24:mi:ss') as hiretime_01
--	, to_char(hiretime, 'yyyy/mm/dd PM hh12:mi:ss') as hiretime_02
	, to_timestamp('2022-03-04 22:10:15', 'yyyy-mm-dd hh24:mi:ss') as hirestamp_01
