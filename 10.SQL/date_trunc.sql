...
-- date타입을 date_trunc해도 반환값은 timestamp타입이다.
select date_trunc('day', to_date('2022-03-06', 'yyyy-mm-dd')) as date_01; 

-- 만약 date 타입을 그대로 유지하려면 ::date로 명시적 형변환
select date_trunc('day', '2022-03-03'::date)::date as date_01; 

-- 월, 년으로 절삭.
select date_trunc('month', '2022-12-31'::date)::date as date_01; 
